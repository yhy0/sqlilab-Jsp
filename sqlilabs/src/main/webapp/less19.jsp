...
<div style=" margin-top:70px;color:#FFF; font-size:23px; text-align:center">Welcome&nbsp;&nbsp;&nbsp;<font
    ...
    <font size="4" color="#FFFF00">
        ...
        基于头部的Referer POST报错注入</br></br></br>
        ...
        <%
            String uagent = request.getHeader("Referer");
                ...
                if(uname != null && passwd !=null) {
                    ...
                    try {
                        ...
                        if(rs.next()) {
                            flag = true;
                            String
                                    insert="INSERT INTO referers(referer, ip_address) VALUES ('" + uagent +
                                    "', '" + ip + "')";

                            con.insert(insert);
        %>
        <font color= "#0000ff" font size = 3 >
            Your User Referer is: <%=uagent%>
        </font>
