...
<div style=" margin-top:70px;color:#FFF; font-size:23px; text-align:center">Welcome&nbsp;&nbsp;&nbsp;<font
    ...
    <font size="4" color="#FFFF00">
        ...
        基于错误的复杂的(Base64加密)字符型Cookie注入<br><br><br></font>
    <%
        ...
        if(cookie == null) {
            ...
            out.println("<img src='../images/Less-21.jpg' />");
            out.println("</center>");
                ...
                if(uname != null && passwd !=null) {
                    ...
                    try {
                        ...
                        if(rs.next()) {
                            ...
                            // cookie base64加密
                            cookie = new Cookie("uname", Base64.getEncoder().encodeToString(name.getBytes()));
                            cookie.setMaxAge(60 * 60 * 24);
                            response.addCookie(cookie);
                            out.println("<font color= '#FFFF00' font size = 3 >I LOVE YOU COOKIES</font> <br>");
                            out.println("<center>");
                            out.println("<form action='/less21.jsp' method='post'>");
            ...
            out.println("<br></font>");
            // cookie base64解密
            String encodeName = cookie.getValue();
            byte[] decodedBytes = Base64.getDecoder().decode(encodeName);
            String decodeName = new String(decodedBytes);
            System.out.println("     ----  " +decodeName);
            String sql1 = "SELECT * FROM users WHERE username='" + decodeName + "' LIMIT 0,1";
